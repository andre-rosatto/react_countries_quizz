...
<b>Flagle</b> is a quiz where you have to guess the country from its flag and some general information.

<b>Flagle</b> was written in Typescript, using React and Tailwind CSS, and consuming the REST Countries API.
...
## Scripts
```npm start```: Starts the app in development mode and serves it on ```localhost:3000```
